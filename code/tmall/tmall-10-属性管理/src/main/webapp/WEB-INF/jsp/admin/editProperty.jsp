                ...
                <table class="editTable">
                    ...
                    <tr class="submitTR">
                        <td colspan="2" align="center">
                            <input type="hidden" name="id" value="${p.id}"> <!--在editProperty.jsp中隐式提供id-->
                            <input type="hidden" name="cid" value="${p.category.id}"> <!--在editProperty.jsp中隐式提供cid,通过p.category.id获取-->
